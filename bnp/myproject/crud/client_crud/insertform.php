...
<div class="container">
  ...
  <form class=""  action="insert.php" method="post">
    <section class="form-inline first">
      ...
      <input type="text" maxlength="10" pattern=".{10,}" required title="โปรดกรอกให้ครบ 10 หลัก" class="form-control mb-2 mr-sm-2" name="ramid" id="ramid" placeholder="รหัสนักศึกษา 10 หลัก" required="required" autofocus>
      <label class="sr-only" for="inlineFormInputName2">รหัส พ.ร.</label>
      <input type="text" class="form-control mb-2 mr-sm-2" name="prid" id="prid" placeholder="รหัส พ.ร." required>
    ...
    <section class="form-inline third">
      ...
      <input type="text" class="form-control mb-2 mr-sm-2" name="name" id="name" placeholder="ชื่อ" required>

      <label class="sr-only" for="inlineFormInputName2">นามสกุล</label>
      <input type="text" class="form-control mb-2 mr-sm-2" name="surname" id="surname" placeholder="นามสกุล" required>
    ...
    <section class="form-inline third">
      ...
      <input type="number" min="10000" max="99999" class="form-control mb-3 mr-sm-3" name="postcode" id="postcode" placeholder="รหัส ป.ณ.">
