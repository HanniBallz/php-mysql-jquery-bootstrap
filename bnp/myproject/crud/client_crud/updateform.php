...
<div class="container">
  ...
  <form action="update.php" method="post">
    <div class="col-sm-4">
          ...
          <input type="text" maxlength="10" pattern=".{10,}" required title="โปรดกรอกให้ครบ 10 หลัก" class="form-control" name="ramid"
            id="ramid" value="<?php echo $row_show['ram_id']?>" placeholder="รหัสนักศึกษา 10 หลัก" required="required" autofocus>
        ...
        <div class="col-sm-4">
          ...
          <input class="form-control" name="name" id="name" value="<?php echo $row_show['name']?>" placeholder="ชื่อ" required>

          <label for="surname"><span class="label label-primary">นามสกุล :</span></label>
          <input class="form-control" name="surname" id="surname" value="<?php echo $row_show['surname']?>" placeholder="นามสกุล" required>

        <label for="surname"><span class="label label-primary">รหัสไปรษณีย์ :</span></label>
        <input type="number" min="10000" max="99999" class="form-control" name="postcode"
          id="postcode" value="<?php echo $row_show['postcode']?>" placeholder="รหัสไปรษณีย์ (ใส่หรือไม่ก็ได้)">

      </div>

          <div class="col-sm-4">
            <label for="epass"><span class="label label-default">รหัส e-service :</span></label>
            <input class="form-control" name="epass" id="epass" value="<?php echo $row_show['e_pass']?>" placeholder="รหัสผ่าน e-service (ถ้ามี)">
            <label for="pid"><span class="label label-default">เลขบัตรประจำตัวประชาชน :</span></label>
            <input type="text" maxlength="13" class="form-control" name="pid" id="pid" value="<?php echo $row_show['p_id']?>" placeholder="เลขบัตรประจำตัวประชาชน 13 หลัก">
            <!-- <input type="text" maxlength="13" pattern=".{13,}" required title="โปรดกรอกให้ครบ 13 หลัก"> -->
            <label for="telephone"><span class="label label-default">เบอร์โทรศัพท์ :</span></label>
            <input type="text" maxlength="" class="form-control" name="telephone" id="telephone" value="<?php echo $row_show['telephone']?>" placeholder="เบอร์โทร (ใส่หรือไม่ก็ได้)">
        ...
        <label for="birth_date"><span class="label label-default">วัน เดือน ปีเกิด</span> </label>
          ...
          <select name="birthdate" id="birthdate" class="form-control">
            <option value="<?php echo $row_show['birth_date']?>"><?php echo $row_show['birth_date']?></option>
            <?php
        			for($n=1;$n<=31;$n++)
        			{
        		?>
          ...
          <option value="<?php echo $row_show['birth_month']?>"><?php echo $row_show['birth_month']?></option>
          ...
          <option value="<?php echo $row_show['birth_year']?>"><?php echo $row_show['birth_year']?></option>
          <?php
            for($n=date("Y")+543;$n>=2460;$n--)
            {
          ?>
          <option value="<?php echo $n; ?>"><?php echo $n; ?></option>
          <?php
