...
<head>
<title>ฟอร์มควบคุมการลงทะเบียนเทอม Summer </title>
...
<script src="function.js?Ver=0006"></script>
<script src="callfunction.js?Ver=0006"></script>
...
<h2 align="center"><i class="fas fa-anchor" id="noprints" style="font-size:24px;color:#ff9900"></i>
  ใบควบคุมการลงทะเบียนเทอม <span class="thisterm">Summer</span> <i class="fas fa-anchor" style="font-size:24px;color:#ff9900" id="noprintss"></i>
</h2>
