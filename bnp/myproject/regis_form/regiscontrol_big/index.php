...
<head>
<title>ฟอร์มควบคุมการลงทะเบียนเทอม 1-2 </title>
...
<script src="function.js?Ver=0009"></script>
<script src="callfunction.js?Ver=0009"></script>
...
<h2 align="center"><i class="fas fa-anchor" id="noprints" style="font-size:24px;color:#ff9900"></i>
  ใบควบคุมการลงทะเบียนเทอม <span class="thisterm">1-2</span> <i class="fas fa-anchor" style="font-size:24px;color:#ff9900" id="noprintss"></i>
</h2>
  ...
  <div class="col-md-4">
    <div class="form-inline">
        ...
        <select class="form-control" id="regis_date">
          ...
          <option class="red" value=""></option>
          <option class="blue" value=""></option>
          <option class="green" value=""></option>
          <option class="purple" value=""></option>
        </select>
      </div>
  </div>
...
<form action="">
	<table class="table table-sm table-hover" >
        ...
        <td width="7%" class="borderd"> <input type="text" id="gen<?php echo $i;?>" name="gen<?php echo $i;?>" class="gen"> </td>
				...
				<td width="" class="borderd"> <input type="number" id="credit<?php echo $i;?>" name="credit<?php echo $i;?>" class="credit" maxlength=""> </td>
        ...
        <td width="" class="borderd"> <input type="number" min="0" id="datefee<?php echo $i;?>" name="datefee<?php echo $i;?>" class="datefee"> </td>
				<td width="" class="borderd"> <input type="number" min="0" id="keepcost<?php echo $i;?>" name="keepcost<?php echo $i;?>" class="keepcost"> </td>
