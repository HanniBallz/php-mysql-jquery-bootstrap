$(document).ready(function(){
  ...
  $('button.call').on('click', function (){
   ...
   // ส่วนของราม
    var CostNewer	 =	500;	// ค่าบำรุง 60 ขึ้นไป
    var CostNew	   =	300;	// ค่าบำรุง 55 - 59 และพรีดีกรี 60 ขึ้นไป
    var CostOld	   =	200;	// ค่าบำรุงปี 54 ลงมาและพรีดีกรี 59 ลงมา
    var News		   = 	0;	// ค่าข่าวราม
   ...
   // ส่วนของเพื่อนเรียน
    ...
    var New_Person  = 842.86; // ราคาบุคคลทั่วไป รหัส 60 ขึ้นไป/ และราคานักศึกษาที่มีรหัส 60065 ขึ้นไปทุกสถานะ
